...
public class CargaDBEJB {
	...
	public void init() {
		...
		Tienda tienda1 = new Tienda("Identificador_tienda_1","Descripción de la tienda 1 que debe ser minimo de sesenta caracteres.");
		em.persist(tienda1);
		em.flush();
		Tienda tienda2 = new Tienda("Identificador_tienda_2","Descripción de la tienda 2 que debe ser minimo de sesenta caracteres.");
		em.persist(tienda2);
		em.flush();
		Servidor servidor1 = new Servidor("Identificador_servidor_1","Descripción del servidor 1 que debe ser minimo de sesenta caracteres.");
		em.persist(servidor1);
		em.flush();
		Servidor servidor2 = new Servidor("Identificador_servidor_2","Descripción del servidor 2 que debe ser minimo de sesenta caracteres.");
		em.persist(servidor2);
		em.flush();
		Cloud cloud1 = new Cloud("Identificador_cloud_1","Descripción del cloud 1 que debe ser minimo de sesenta caracteres.");
		em.persist(cloud1);
		em.flush();
		Cloud cloud2 = new Cloud("Identificador_cloud_2","Descripción del cloud 2 que debe ser minimo de sesenta caracteres.");
		em.persist(cloud2);
		em.flush();
		Cluster cluster1 = new Cluster("Identificador_cluster_1","Descripción del cluster 1 que debe ser minimo de sesenta caracteres.");
		em.persist(cluster1);
		em.flush();
		Cluster cluster2 = new Cluster("Identificador_cluster_2","Descripción del cluster 2 que debe ser minimo de sesenta caracteres.");
		em.persist(cluster2);
		em.flush();
